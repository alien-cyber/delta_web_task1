...
function fire() {
    ...
    bullet.style.left = (boxRect.left + boxRect.width / 2) + 'px';
    bullet.style.top = (boxRect.top + boxRect.height / 2) + 'px';
    ...
    const interval = setInterval(() => {
        if (index < missilePath.length) {
            ...
            clearInterval(interval); // Stop animation when reaching the end of the path
